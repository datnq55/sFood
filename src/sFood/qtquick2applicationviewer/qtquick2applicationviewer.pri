...
# The code below handles deployment to Android Auto and Maemo, aswell as copying
...
#    plugin {
        ...
        for(deploymentfolder, DEPLOYMENTFOLDERS) {
            ...
            target = $$eval($${deploymentfolder}.target)/$$last(sourcePathSegments)
...
#        plugin {
            ...
            for(deploymentfolder, DEPLOYMENTFOLDERS) {
                ...
                source = $$replace(source, \\\\, /)
                macx {
                    target = $${TARGET}.app/Contents/Resources/$$eval($${deploymentfolder}.target)
                } else {
                    target = $$eval($${deploymentfolder}.target)
                }
                target = $$replace(target, \\\\, /)
